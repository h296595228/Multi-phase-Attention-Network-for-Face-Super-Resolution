...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/kemove/dev/ffhq/X3',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='/home/kemove/dev/ffhq/X3',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='DIV2K',
                    help='test dataset name')
parser.add_argument('--data_range', type=str, default='1-22000/22001-24000',
